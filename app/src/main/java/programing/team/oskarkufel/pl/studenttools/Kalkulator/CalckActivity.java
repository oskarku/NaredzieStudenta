package programing.team.oskarkufel.pl.studenttools.Kalkulator;
...
public class CalckActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calck);
        setTitle("StudentTool Kalkulator");
    ...
    private void obtainInputValues(String input){
        switch (input){
            ...
            case "ABS":
                ...
                break;
            case "MR":
                String mValue = getStoredPreferenceValue(CalckActivity.this);
    ...
    public void onClick(View view) {
        ...
        if(data.equals("AC")){
            ...
            String enteredInput = outputResult.getText().toString();
            // call Rate function that will return the result of the calculate.
